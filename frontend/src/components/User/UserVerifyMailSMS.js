  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(
        `${process.env.REACT_APP_BACKEND_URL}/api/verifyotpreg`,
        {
          method: "POST",
      ...
      if (response.success) {
        toast.success("OTP verifyed succesfully!", {
          position: "top-right",
          autoClose: 1000,
  ...
  return (
    <>
      <div className="flex items-center ">
        ...
        <div className="flex items-center">
          <div className="text-2xl font-bold mx-2 my-8 px-4">Verify OTP</div>
        </div>
      </div>
      {loader ? (
...
export default UserVerifyMailSMS;
