  ...
  const validateWinsForm = () => {
    ...
    $("#winsForm").validate({
      ...
      messages: {
        ...
        contact: {
          required: "Plase enter contact value",
        },
      },
      errorElement: "div",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(
        `${process.env.REACT_APP_BACKEND_URL}/api/sendmailsms`,
        {
          method: "POST",
      ...
      if (response.success) {
        toast.success("Mail and SMS sent succesfully!", {
          position: "top-right",
          autoClose: 1000,
...
export default UserSendMailSMS;
